...
// Loads the real Knight model + texture + animations. The loadingManager
// passed in tracks this automatically (onProgress/onLoad above fire based
// on it), so the loading screen now reflects real asset loading instead
// of the placeholder bootstrap trick this used to need.
