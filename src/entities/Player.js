...
// Paths to the actual files you downloaded. Change MODEL_PATH if you
// swap to a different KayKit character later.
const MODEL_PATH = './models/player/Knight.glb';
const TEXTURE_PATH = './models/player/knight_texture.png';
...
export class Player {
    ...
    async loadModel(loadingManager) {
        ...
        AssetLoader.applyTexture(gltf.scene, texture);
